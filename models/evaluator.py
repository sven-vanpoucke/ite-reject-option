...
def evaluation_binary(treated_y_test, treated_y_pred, control_y_test, control_y_pred):
    digits= int(2)
...
treated_fpr, treated_tpr, _ = roc_curve(treated_y_test, treated_model.predict_proba(treated_x_test)[:, 1])
control_fpr, control_tpr, _ = roc_curve(control_y_test, control_model.predict_proba(control_x_test)[:, 1])
