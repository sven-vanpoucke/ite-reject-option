...
def distance_test_to_train(model, test_data, n_neighbors=1):
...
def execute_ood_experiment(train_x, model_class, test_x, bounds, test_set, file_path, key_metric, metrics_results, model_options=None):
