...
def execute_one_class_classification_experiment(train_x, model_class, test_x, bounds, test_set, file_path, key_metric, minmax, metrics_results, model_options=None):
